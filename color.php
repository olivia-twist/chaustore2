...
<html lang="fr" dir="ltr">
  ...
  <body>
   ...
   <tbody>
     <?php require_once('color_afficher.php');?>

     <?php while ($row= mysqli_fetch_array($req)) {
       ?>
     <tr>
       <td><?php echo $row['name']; ?></td>
       <td><a href="color_update.php" target="_top" title="modifier">Modifier</a></td>
       <td><a href="color_delete.php?id_brand=<?php echo $row['id_brand'];?>" target="_blank" title="Supprimer">Supprimer</a></td>
       <?php } ?>
       </tr>
  </tbody>
   </table>

   <?php require_once('color_insert.php') ?>
   <form method= "POST">
